...
namespace Orleans.Transactions
{
        ...
        where TState : class, new()
    {
        ...
        public TransactionalState(TransactionalStateConfiguration transactionalStateConfiguration,
            IGrainContextAccessor contextAccessor, ITransactionDataCopier<TState> copier, IGrainRuntime grainRuntime,
                ...
                .EnterLock<TResult>(
                    ...
                    () =>
                    {
                        ...
                        if (logger.IsEnabled(LogLevel.Debug))
                            logger.LogDebug(
                                "Update-lock read v{SequenceNumber} {TransactionId} {Timestamp}",
        ...
        public void Participate(IGrainLifecycle lifecycle)
        {
            lifecycle.Subscribe<TransactionalState<TState>>(
                ...
                (ct) => OnSetupState(SetupResourceFactory, ct));
        }

        private static void SetupResourceFactory(IGrainContext context, string stateName,
            TransactionQueue<TState> queue)
        {
            ...
            context.RegisterResourceFactory<ITransactionalResource>(
                stateName,
                () => new TransactionalResource<TState>(queue));

            // Add tm factory to the grain context
            context.RegisterResourceFactory<ITransactionManager>(stateName, () =>
            ...
            CancellationToken ct)
        {
            ...
            this.participantId = new ParticipantId(
                ...
                this.context.GrainReference,
                this.config.SupportedRoles);

            var storageFactory = this.context.ActivationServices
